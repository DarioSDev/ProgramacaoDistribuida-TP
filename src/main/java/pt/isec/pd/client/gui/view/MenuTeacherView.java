...
public class MenuTeacherView extends BorderPane {
    ...
    private final Button newQuestionBtn = new Button("New Question");
    private final Button viewQuestionsBtn = new Button("View Questions");
    ...
    private VBox createButtons() {
        ...
        newQuestionBtn.setOnAction(e -> {
            if (stateManager != null) stateManager.showNewQuestionView(user);
        });
        ...
        viewQuestionsBtn.setOnAction(e -> {
            if (stateManager != null) stateManager.showTeacherQuestions(user);
        });
    ...
    private void setupDropdown() {
        ...
        profileBtn.setOnAction(e -> {
            toggleDropdown();
            if (stateManager != null) stateManager.showEditProfile(user);
        });
        ...
        logoutBtn.setOnAction(e -> {
            toggleDropdown();
            if (stateManager != null) stateManager.showLogin();
        });
